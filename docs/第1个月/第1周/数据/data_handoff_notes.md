...
```text
docs/第1个月/第1周/数据/akshare_probe.md
docs/第1个月/第1周/数据/pytdx_probe.md
docs/第1个月/第1周/数据/data_source_probe.md
docs/第1个月/第1周/数据/data_issue_list.md
docs/第1个月/第1周/数据/data_handoff_notes.md
```
...
```bash
python jobs/week1_data_engineer_run.py --start-date 2023-01-01 --end-date 2026-07-07 --run-id 手工指定run_id
```
